...
void VkUtil::BarrierEmitter::Clear()
{
	imageBarriers.clear();
}
...
void VkUtil::BarrierEmitter::EmitBarrierAndFlush(VkCommandBuffer cmd)
{
	EmitBarrier(cmd);
	Clear();
}
...
void VkUtil::BarrierEmitter::TransitionImage(VkImage image, VkImageLayout currentLayout, VkImageLayout newLayout)
{
